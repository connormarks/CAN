...
def main():
    model_path = r"C:\cs175\project\CAN\run\run_9\best.pt" #run goes here
    data_path = r"C:\cs175\project\CAN\SyntheticDataGeneration\Output\Merged\merged_data.json" #this stays fixed
    output_path = r"C:\cs175\project\CAN\test\results.json" #output
