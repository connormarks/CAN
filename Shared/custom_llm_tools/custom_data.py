...
def load_custom_data(vectorizer, path, emotion_mapping, topic_mapping, ekman_idx_to_emotion_mapping, simplify_with_ekman=False, ignore_neutral=False):
    """
    ...
    X, y_emotion, y_topic = preprocess_custom_dataset(X, y_emotion, y_topic, \
